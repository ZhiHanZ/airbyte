...
// verify we have permissions to create/drop stage
  ...
  public static void main(String[] args) throws Exception {
    final Destination destination = DatabendDestination.sshWrappedDestination();
    LOGGER.info("starting destination: {}", DatabendDestination.class);
    new IntegrationRunner(destination).run(args);
    LOGGER.info("completed destination: {}", DatabendDestination.class);  }
